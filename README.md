...
- **개장 급등 추천**: 프리마켓 모멘텀 + 뉴스 촉매 + 기술적 돌파 기반 인트라데이 추천 Top 3 (ATR 기반 동적 목표가/손절가, 보유 30분~1시간)
...
4. 개장 급등 추천 (Opening Surge) — PM +1.5% 이상 종목 중 점수 상위 3개, ATR 기반 목표가/손절가
...
| **핵심 조건** | 칼만 예측가 ≥ 종가+10%, RSI 과매도 등 | 칼만 예측가 > 현재가 | 장기 Kalman velocity > 0, ADX bullish | PM 변동 ≥ +1.5%, 8개 항목 가중 점수 |
