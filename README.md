...
| **핵심 조건** | 칼만 예측가 ≥ 종가+10%, RSI 과매도 등 | 칼만 예측가 > 현재가 | 장기 Kalman velocity > 0, ADX bullish |
| **보유 기간** | 1-4주 | 2-4주 | 1-3개월 |
| **종목 수** | 1개 (최적) | 1개 (단기 추천과 중복 제외) | 최대 3개 |
| **하드 필터** | 칼만 수익률 ≥ 10%, falling knife 제외, 최소 점수 점진적 하향(35→10) | 칼만 예측가 > 종가, 최소 점수 이상 | Kalman velocity > 0, RSI < 75 |
